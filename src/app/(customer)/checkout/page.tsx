        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "16px 16px 8px" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 7 }}>
              ...
              <span style={{ color: "#3ecf6e", fontSize: 11, fontWeight: 700 }}>Thanh toán an toàn qua DakGo</span>
            </div>
            <div style={{ color: "#b0956a", fontSize: 11, lineHeight: 1.7 }}>
              • Tiền được giữ bởi <strong style={{ color: "#f8f0e0" }}>tài khoản đại diện DakGo</strong> — không phải tài khoản cá nhân tài xế.<br />
          ...
          <div style={{
            ...
            {[
              ...
              { label: "Vai trò",      val: "Đại diện DakGo",            hi: false },
    ...
    <>
      ...
      <div style={{ position: "fixed", inset: 0, background: "#080806", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "12px 14px 100px" } as React.CSSProperties}>
          ...
          {/* 3a. XU DakGo */}
          {xuBalance > 0 && (
          <SectionCard title="XU DakGo" icon="🪙">
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
              <div style={{ display:"flex", alignItems:"center", gap:9 }}>
                ...
                <div>
                  <div style={{ color:"#f8f0e0", fontSize:11, fontWeight:600 }}>Dùng XU DakGo</div>
