...
const SECTIONS = [
    ...
    items: [
      {
        ...
        a: "Giao Nhanh thu hoa hồng từ 10%–20% trên doanh thu thực nhận tùy theo loại hình và thỏa thuận ban đầu. Tỷ lệ cụ thể được ghi rõ trong hợp đồng đối tác.",
      },
      {
      ...
      },
      {
        ...
        a: "Hiện tại KHÔNG có phí đăng ký và KHÔNG có phí tháng cố định. Giao Nhanh chỉ thu hoa hồng khi có đơn hàng thành công.",
      },
      {
        q: "Phí ship ai thu?",
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "Giao Nhanh có cam kết gì với quán?",
      ...
      <div style={{ minHeight: "100dvh", background: "#080806", paddingBottom: 40 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ color: "#6a5a40", fontSize: 9.5, marginTop: 1 }}>Điều khoản hợp tác Giao Nhanh</div>
            </div>
            <div style={{
        ...
        <div style={{ padding: "16px 16px 0" }}>
          ...
          <div style={{ textAlign: "center", marginTop: 20, color: "#6a5a40", fontSize: 9.5, lineHeight: 1.6 }}>
            ...
            Giao Nhanh — Phước An, Krông Pắc, Đắk Lắk
          </div>
